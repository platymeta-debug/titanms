...
void PlayerHandler::loadPackets(){
	...
	handlers[TAKE_DAMAGE] = &PlayerHandler::playerTakeDamageHandle;
	handlers[PLAYER_MOVE] = &PlayerHandler::playerMovingHandle;
	handlers[CHANGE_MAP] = &PlayerHandler::changeMapHandle;
	...
	handlers[MOVE_ITEM] = &PlayerHandler::moveItemHandle;
	...
	handlers[LOOT_DROP] = &PlayerHandler::lootDropHandle;
...
void PlayerHandler::connectionRequestHandle(PacketReader& packet){
	...
	player->setUserID(tmpinfo.UserPIds[crid]);
