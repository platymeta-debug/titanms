...
public:
	...
	void summonFromMob(int mobid, int x, int y, bool flip);
	Mob* spawnMob(int mobid, int x, int y, int orgID = -1, bool spawneffect = true, int fh = 0, bool flip = false, bool find = true);
	void clear();
	int getMobsCount();
