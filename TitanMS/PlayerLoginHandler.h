...
private:
	...
	static const short LOGIN_REQUEST = 0x30;
	static const short CHANNEL_SELECT = 0x34;
	static const short WORLD_SELECT = 0x6;
	static const short HANDLE_LOGIN = 0x09;
	static const short SHOW_WORLD = 0x32;
	static const short WORLD_BACK = 0x11;
	static const short CHARACTER_SELECT = 0x88;
	static const short SHOW_CHARACTERS = 0x8;//show chr + login chr server
...
public:
	...
	void showCharactersHandle(PacketReader& packet);
